...
export const aldehydeReactionRules: ReactionRule[] = [
  ...
  },
  {
    ...
    reagents: "1) Ph₃P  2) strong base",
    reagentNote: "Draw the carbonyl compound and alkyl halide; the phosphonium ylide is generated internally",
    productHint: "Alkene",
    explanation:
      "The alkyl halide first forms a phosphonium salt with triphenylphosphine and is deprotonated to the corresponding ylide. That ylide then converts the aldehyde C=O bond into a C=C bond. PocketChem therefore accepts the practical ylide precursor instead of requiring the user to draw a phosphorus ylide explicitly.",
    trigger: aldehydeTrigger,
    additionalReactants: [
      {
        id: "wittig-alkyl-halide-precursor",
        label: "alkyl chloride, bromide, or iodide (ylide precursor)",
        trigger: {
          includeSmarts: ["[C;X4;H1,H2,H3][Cl,Br,I]"],
        },
        supplyMode: "user-structure",
        contributesToProduct: true,
        role: "structural-partner",
        searchAliases: ["alkyl halide", "alkyl bromide", "alkyl iodide", "alkyl chloride", "ylide precursor"],
      },
    ],
    transform: {
      type: "reactionSmarts",
      smarts: "[C:1]=[O:2].[C;X4;H1,H2,H3:3][Cl,Br,I:4]>>[C:1]=[C:3]",
      maxProducts: 8,
    },
    productStatus: "representative",
    mechanism: "Alkyl-halide phosphonium-salt formation → ylide generation → Wittig olefination",
    limitations: [
      "The alkyl halide must have at least one hydrogen on the carbon bearing the leaving group so a phosphorus ylide can be generated.",
      "Methyl and primary alkyl halides are the standard phosphonium-salt precursors; secondary halides can be less efficient because substitution competes with elimination.",
      "Aryl and vinyl halides are not treated as Wittig ylide precursors.",
    ],
    searchAliases: ["Wittig from alkyl halide", "carbonyl plus alkyl halide", "phosphonium salt ylide"],
    priority: 1030,
  },
  {
